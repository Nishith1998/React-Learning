## What is React.js ?
- <h3>A client-side JavaScript library</h3>

- <h3>All about building modern, reactive user interfaces for the web</h3>

- <h3>Declarative, component-focused approach</h3>
...
```jsx
// basic component containg JSX code
...
Main Aspect of composition: what if we want to create a component which actually just serves as a shell around any kind of other conent.
...
> using props.children we can get conent passed between component tags.
...
```
```jsx
// Card component will act as container for conent inside it.
