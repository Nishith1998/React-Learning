...
We can not pass data to sibling components, to do that we must first pass data to parent component (common component containing both siblings) and then from parent to another child via props.
